...
def print_death_age(people_dict):
    ...
    for key, value in people_dict.items():
        ...
        death_age = death - birth
        
        print(f"{name}, Age of Death: {death_age}")
...
def print_marriages(marriages_dict, people_dict):
    ...
    for marriage_key, marriage_list in marriages_dict.items():
        ...
        #first try: wed_age = marriages_dict[WEDDING_YEAR_INDEX] - people_dict[BIRTH_YEAR_INDEX]
        husband_wed_age = wedding_year - husband_birth

        wife_list = people_dict[wife_key]
        wife_name = wife_list[NAME_INDEX]
        wife_birth = wife_list[BIRTH_YEAR_INDEX]

        wife_wed_age = wedding_year - wife_birth
        
        print(f"Husband: {husband_name}, Age: {husband_wed_age} > Wedding Year: {wedding_year} < Wife: {wife_name}, Age: {wife_wed_age}" )
